...
{
  new (message_memory) custom_interfaces::srv::InvKin_Request(_init);
}

void InvKin_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::srv::InvKin_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InvKin_Request_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces::srv::InvKin_Request, pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers InvKin_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::srv::InvKin_Request),
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::InvKin_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, InvKin_Request)() {
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::InvKin_Request_message_type_support_handle;
}
...
void InvKin_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) custom_interfaces::srv::InvKin_Response(_init);
}

void InvKin_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_interfaces::srv::InvKin_Response *>(message_memory);
  typed_message->~InvKin_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember InvKin_Response_message_member_array[1] = {
  {
    "joint_vals",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces::srv::InvKin_Response, joint_vals),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers InvKin_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(custom_interfaces::srv::InvKin_Response),
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::InvKin_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, InvKin_Response)() {
  return &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::InvKin_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers InvKin_service_members = {
  ...
  // see get_service_type_support_handle<custom_interfaces::srv::InvKin>()
...
get_service_type_support_handle<custom_interfaces::srv::InvKin>()
{
  ...
  auto service_type_support =
    &::custom_interfaces::srv::rosidl_typesupport_introspection_cpp::InvKin_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, InvKin)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<custom_interfaces::srv::InvKin>();
}
